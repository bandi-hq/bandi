...
export function SkillsPage() {
  ...
  if (state.runtime === 'desktop') return <><PageHeader backTo="/assets" title="技能" description="Desktop 当前只提供受管配置资产的只读索引。" /><MockBoundaryNote>请返回资产索引查看已发现的技能配置；当前不提供安装、更新、回滚或卸载。</MockBoundaryNote></>
