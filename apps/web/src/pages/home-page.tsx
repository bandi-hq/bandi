...
export function HomePage() {
  ...
  return <>
    <PageHeader title="配置概览" description="查看最近配置、待处理事项与当前工作区，再回到已加入的 AI 编程工具使用。" action={<Button variant="outline" onClick={() => dispatch({ type: 'TOAST', text: 'Web mock 未执行本机扫描 · 未读取文件或运行命令' })}><ScanSearch size={16} />查看扫描边界</Button>} />
